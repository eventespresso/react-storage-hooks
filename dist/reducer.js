...
function useStorageReducer(storage, key, reducer, defaultInitialArg, defaultInit) {
    ...
    var _a = (0, react_1.useReducer)(addForceStateActionToReducer(reducer), (0, common_1.useInitialState)(storage, key, defaultState)), state = _a[0], dispatch = _a[1];
    (0, common_1.useStorageListener)(storage, key, defaultState, function (newValue) {
